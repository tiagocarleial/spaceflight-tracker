...
const STARLINK_1744_YOUTUBE_ID = 'VKWKVii3WPo';
...
export default function LaunchCard({ launch }: LaunchCardProps) {
  ...
  const isStarlink1047 = isFalcon9 && launch.name.toLowerCase().includes('starlink group 10-47');
  ...
  const isHASTE = launch.name.toLowerCase().includes('haste') && !launch.name.toLowerCase().includes('curveball');
  const isStarlink1744 = isFalcon9 && launch.name.toLowerCase().includes('starlink group 17-44');
      ...
      <div className="flex gap-2 mt-auto">
        ...
        {launch.livestream && timeLeft.total > -3600000 && timeLeft.total <= 5400000 ? (
          ...
          <>
            ...
            {isStarlink1047 && (
              <button
                onClick={() => setVideoModalId(STARLINK_1047_YOUTUBE_ID)}
                className="flex-1 bg-red-700 hover:bg-red-600 text-white text-sm font-medium py-2 px-4 rounded transition-colors"
              >
                ▶ Watch Now
              </button>
            ...
            {isStarlink1053 && (
              <button
                onClick={() => setVideoModalId(STARLINK_1053_YOUTUBE_ID)}
                className="flex-1 bg-red-700 hover:bg-red-600 text-white text-sm font-medium py-2 px-4 rounded transition-colors"
              >
                ▶ Watch Now
              </button>
            ...
            {isStarlink1747 && (
              <button
                onClick={() => setVideoModalId(STARLINK_1747_YOUTUBE_ID)}
                className="flex-1 bg-red-700 hover:bg-red-600 text-white text-sm font-medium py-2 px-4 rounded transition-colors"
              >
                ▶ Watch Now
              </button>
            ...
            {isStarlink1744 && (
              <button
                onClick={() => setVideoModalId(STARLINK_1744_YOUTUBE_ID)}
                className="flex-1 bg-red-700 hover:bg-red-600 text-white text-sm font-medium py-2 px-4 rounded transition-colors"
              >
                ▶ Watch Now
              </button>
